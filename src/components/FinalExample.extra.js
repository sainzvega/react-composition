...
function GroupedDropdown({ onSelect, options }) {
  return (
    <CompoundDropdown onSelect={onSelect}>
...
export default function FinalExampleCExtra() {
    ...
    <main className="App">
      <div className="Toolbar">
        ...
        <div className="Toolbar__item">
          ...
          <GroupedDropdown options={groupedNames} onSelect={handleSelect} />
        </div>
      </div>
    </main>
  );
